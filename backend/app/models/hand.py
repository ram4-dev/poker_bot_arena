...
class Hand(Base):
    ...
    player_1_stack_after: Mapped[int | None] = mapped_column(Integer, nullable=True)
    player_2_stack_after: Mapped[int | None] = mapped_column(Integer, nullable=True)
